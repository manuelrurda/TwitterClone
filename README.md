...
* [x] User can **compose and post a new tweet**
    * [x] User can click a “Compose” icon in the Action Bar on the top right (Moved compose button to look more like Twitter)
...
Endelss Scrolling was a challenge to figure out.
